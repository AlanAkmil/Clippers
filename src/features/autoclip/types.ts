...
export interface Highlight {
  ...
  /** Why the AI picked this window — only set when it came from AI scoring. */
  reason?: string;
  source?: "ai" | "heuristic";
}

/** A single viral-moment suggestion returned by the AI scoring model. */
...
/** Result of sending audio to the AI transcription model. */
